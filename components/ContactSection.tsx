        ...
        <ScrollReveal>
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-10">
            <a
              ...
              className="flex-1 min-h-[52px] flex items-center justify-center gap-3 bg-[#25D366] text-white font-semibold rounded-xl hover:bg-[#1ebe5d] transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-[#25D366] text-base"
            >
            ...
            <a
              ...
              className="flex-1 min-h-[52px] flex items-center justify-center gap-3 bg-navy text-white font-semibold rounded-xl hover:bg-navy-light transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-navy text-base"
            >
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6 md:p-8">
            <h3 className="font-serif text-xl font-semibold text-navy mb-6">Send an Enquiry</h3>
            <EnquiryForm />
          </div>
        </ScrollReveal>
      </div>
