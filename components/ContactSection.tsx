          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
            <div className="flex flex-col gap-6">
              <a
                ...
                className="w-full py-4 flex items-center justify-center gap-4 border border-[#25D366]/30 bg-transparent text-[#25D366] font-light tracking-[0.1em] uppercase text-xs hover:bg-[#25D366] hover:text-white transition-all duration-300"
              >
              ...
              <a
                ...
                className="w-full py-4 flex items-center justify-center gap-4 border border-luxury-charcoal bg-transparent text-luxury-charcoal font-light tracking-[0.1em] uppercase text-xs hover:bg-luxury-charcoal hover:text-luxury-stone transition-all duration-300"
              >
            ...
            {/* Enquiry form */}
            <div className="bg-luxury-black p-8 md:p-10 border border-luxury-stone/5 shadow-2xl relative">
              <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-luxury-gold/20 via-luxury-gold to-luxury-gold/20" />
              <h3 className="font-serif text-2xl font-light text-luxury-stone mb-8 text-center tracking-wide">Register Interest</h3>
              <EnquiryForm />
            </div>
          </div>
        </ScrollReveal>
